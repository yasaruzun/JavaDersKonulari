...
public class C01_ElementEkleme {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar.add(10)); //true-- eger kontrol etmek istersem b sehıl de yazailiriz
        ...
        //sayilar listesinin basindaki 44'den sonraya listeyi ekleyin
