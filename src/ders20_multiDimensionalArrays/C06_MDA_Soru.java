...
public class C06_MDA_Soru {
    public static void main(String[] args) {
     ...
     ikiKatliArrayInnerSonElTopla(arr);

        }
    public static void ikiKatliArrayInnerSonElTopla(int[][] arr){
        ...
        System.out.println("Inner array'lerin son elementlerini toplami :" +toplam);
    }
}
