...
public class C04_Soru {
    public static void main(String[] args) {
        ...
        //verilen bir cumlede kullanilan karakterleri ve
        //kacar kere kullanildigini yazdirin
...
////[J, a, v, a, y, i,  , b, a, l, o, n, u,  , p, a, t, l, a, t, m, a, d, a, n,  , b, i, t, i, r, e, l, i, m]
        ...
        for (int i = 0; i < strArr.length ; i++) {
            ...
            //ele aldigim element map'de varsa kullanim miktarini(value) 1 arttrir

            kullanimMiktarlariMap.computeIfPresent(strArr[i],(k,v)->v+1);

            //ele aldigim element map'de yoksa kullanim miktari 1 olarak map'e ekleyecegiz
